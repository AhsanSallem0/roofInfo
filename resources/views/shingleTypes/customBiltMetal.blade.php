...
<div class="body_content">
    ...
    <h1>Shingles by Custom Bilt Metal</h1>
    
<a href="/perl/review.pl?brand_id=223&amp;equip_type=shingle">Write a review of Custom-Bilt shingles</a>

    <p>
        Custom Bilt Metal (CBM) offers several types of metal roofing shingles. The 
        <a href="/shingles/brands/vail-metal-systems.html">Vail</a> Titan Select is made from heavy-gauge steel, while the Vail Majestic 
        Copper Shingle is manufactured of solid copper, while the Country Manor shakes are made from aluminum. A full line of classically 
        styled standing seam roofing products also is available. 
    </p>

    <p>
        The company claims that its metal roofing shingles hold up in heavy weather conditions, such as heavy snow or high winds. It also 
        claims that these products don't require maintenance. 
    </p>
    <h3>Corporate History</h3>
    <p>
        CBM began as a distributor of rain gutter products in 1974. Founded in southern California, the company expanded across the western 
        United States for the next 15 years. In 1990 the company became active in the metal roofing shingle and shake market. 
    </p>
    <p>
        In 2004 CBM acquired the rights to produce and distribute <a href="/shingles/brands/vail-metal-systems.html">Vail Metal Systems'</a>
        VAIL® metal shingle
    </p>
    <p>
        CBM is a member of or affiliated with the following organizations: Energy Star Partner, Metal Roofing Alliance, National Roofing 
        Contractors Association, Western States Roofing Contractors Association, Construction Services Institute, Metal Construction 
        Association, Cool Roof Rating Council, the U.S. Green Building Council, Roofing Consultants Inc.  and General Contractors Association 
        of Hawaii. 
    </p>
    <h3>Roof Repair</h3>
    <p>
    ...
    <h3>Contacting Custom Bilt Metal</h3>
    <div class="mailing_addr">
        Custom Bilt Metal Corporate Headquarters<br>
        1333 Corporate Drive, Suite 103<br>
    ...
    <h3>Warranty</h3>
    <p>
        CBM offers a pro-rated lifetime coating warranty for residential products. The warranty extends only to the original homeowner, with 
        completed registration of the product, but guarantees that the paint will not peel, check, chip or crack, or fade or change color 
        within the first five years. For commercial roofing products, the company offers a 30-year limited warranty.
    </p>
    <p>
