...
<div class="body_content">
    ...
    <h1>Royal Building Supplies (Dura™) Shingles</h1>
    
<a href="/perl/review.pl?brand_id=247&amp;equip_type=shingle">Write a review of Royal shingles</a>
<br><a href="/shingles/reviews/royal/">Read Reviews of Royal Shingles </a>
    <h3>Products</h3>
    <p>
        Royal Building Supplies is the manufacturer of Dura&amp;trade Slate Shingles. These shingles are 
        made using a patented process of recycled plastics and rubber which produces a shingle that 
        resembles slate. The polymer shingles will not crack or split with freezing temperatures.
    </p>

    <p>
        Royal Building Supplies also manufactures the Dura Slate Roofing system. Dura Slate shingles 
        are available in 5 colors.
    </p>
    <h3>History</h3>
    <p>
        Royal Building Supplies, headquartered in Ontario, Canada, is a division of Royal Group 
        Technologies Limited, a manufacturer of polymer-based home products. Royal Building shingles 
        are sold primarily in North America.
    </p>
    <h3>Dura Shingles Warranty</h3>
    <p>
        Dura Slate Shingles carry a 50-year transferable limited warranty. The warranty covers 
        replacement materials and labor for shingles damaged as a result of manufacturers' defects. 
        The warranty offers lifetime hail protection. The shingles carry Class A and C 
        <a href="/definitions/fire_ratings.html">fire resistance</a>, Class 4 impact resistances, 
        warranty against wind speeds of 70 mph. On some shingles, a 100-mph wind warranty is available. 
        As always, you should inspect any warranty carefully to make sure you understand its terms.
    </p>
    <h3>Roof Repair</h3>
    <p>
    ...
    <h3>Contacting Royal Building Supplies</h3>
    <p>
        Phone: 905-264-0701  
    </p>
    <p>
        Mail:<br>  
            ...
            Royal Group Technologies Limited<br>
