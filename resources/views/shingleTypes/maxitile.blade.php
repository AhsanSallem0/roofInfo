...
<div class="body_content">
    ...
    <h1>MaxiTile Roof Siding</h1>
    <p>
	MaxiTile specializes in roofing and siding products and is headquartered in Texas. Their mission is be considered
	North America's top choice for fiber cement products.
    </p>
    <p>
	 The company offers roofing products made from natural and synthetic fibers, sand, cement, additives and pigments.
	The company describes their products as: lightweight, easy to apply and affordable. As with all MaxiTile products, 
	the roofing range is fire retardant and very durable. 
    </p>

    <p>
	Consumers can choose from the following MaxiRoofing products:
    </p>
    <ul>
	<li> MaxiLITE P10: A Spanish inspired product, the MaxiLite P10 comes is a 4-Corrugated tile that adds that traditional Spanish beauty.</li>
	<li> MaxiSHAKE and Maxi SLATE: these products give the appearance of wood and stone, respectively.</li>
	<li> MultiSLATE: fiber-cement product that mimics the appearance of stone.  Suitable for European-style architecture.</li>
    </ul>
    <h3>Care and Maintenance</h3>
    <p>
	MaxiTile gives some guidelines on care and maintenance on their warranty sheet and the main points to note are:
    </p>
    <ul>
	<li> If fungus begins to grow on the roof, take all steps necessary to remove it quickly </li>
	<li> Avoid using power spray devices for washing the roof </li>
	<li> Only use manufacturer approved cleansing materials </li>
	<li> Clear the roof of all pine needles, dirt, leaves and such debris on an annual basis </li>
	<li> Keep walking on the roof to a minimum </li>
    </ul>
    <h3>Warranties</h3>
    <ul>
	<li> The product must be installed in one of the 50 US States. </li>
	<li> Must have been installed by a licenced contractor and maintained as directed. </li>
	<li> If the product is damaged, consumers must make every effort to protect property that could be affected by the defect. </li>
    </ul>
    <p>
	Defect or damage due to fungus or mould growth is not covered by the warranty. 
    </p>
    <h3>Roof Repair</h3>
    <p>
    ...
    <h3>Contact Information for MaxiTile</h3>
    <div class="mailing_addr">
	MAXITILE, Inc.<br>
	12950 Country Parkway, Suite 180<br>
	San Antonio, TX 78216<br><br>
	Customer Service Phone number: (800) 451-2003 <br><br>
	Corporate Office Phone number: (210) 545-7310
    </div>
