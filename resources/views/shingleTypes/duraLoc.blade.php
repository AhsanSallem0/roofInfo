...
<div class="body_content">
    ...
    <h1>Dura-Loc Shingles</h1>
    
<a href="/perl/review.pl?brand_id=226&amp;equip_type=shingle">Write a review of Dura-Loc shingles</a>
<br><a href="/shingles/reviews/dura-loc/">Read Reviews of Dura-Loc Shingles </a>
    <p>
        Dura-Loc Roofing Systems, now known as Allmet, makes metal roofing systems for steep-slope commercial and residential buildings. 
        Allmet/Dura-Loc features granular coating on shingles made to replicate the look of tiles, slate and shake shingles. 
    </p>
 
    <p>
        According to the manufacturer, Allmet <a href="/shingles/metal.html">metal shingles</a> weigh far less than the traditional roofing materials. 
        Today, Allmet offers eight shingle styles: Ridgewood and Wood shake shingles; Talavera and Continental barrel tiles; Tudor and Shadowline 
        slate tile; and Granite Ridge and Guardian asphalt-style shingles. 
    </p>
    <p>
        Allmet shingles are Class A <a href="/definitions/fire_ratings.html">fire-resistant</a>, Class 4 <a href="/definitions/hail_ratings.html">hail-rated</a>
        and warranted against high strength winds. Allmet makes its shingles in 22 different color options. Several metal shingles feature Energy Star®-qualified
        finishes. 
    </p>
    <h3>Allmet / Dura-Loc's History</h3>
    <p>
        Allmet is based in Courtland, Ontario. The company was acquired under its Dura-Loc Roofing Systems Ltd. name by Metals USA Inc. in May 2006. In 
        2007 Metals USA rebranded the Dura-Loc division as Allmet Roofing Products. In 2013, Metals USA was acquired by Reliance Steel and Aluminum Co. 
    </p>
    <p>
        For 2012, Metals USA reported approximately $2 billion in net sales, $19 million of which were for its Building Products division. 
    </p>
    <h3>Roof Repair</h3>
    <p>
    ...
    <h3>Contacting Allmet / Dura-Loc</h3>
    <div class="mailing_addr">
        Allmet Roofing Products<br>
        P.O. Box 220<br>
        Courtland, Ontario N0J 1E0 <br>
        Canada<br><br>
        Phone: (800) 265-9357
    </div>
    <h3>Warranty</h3>
    <p>
        Allmet offers a transferable 50-year limited warranty on its shingles. The warranty ensures the products will be free from defects in 
        manufacturing and workmanship and will resist damage from winds of up to 120 miles per hour as well as from hail. The warranty also states that 
        the product will not deteriorate "beyond normal weathering" including minor granule loss.
    </p>
    <p>
