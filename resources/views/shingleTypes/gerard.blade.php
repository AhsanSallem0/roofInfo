...
<div class="body_content">
    ...
    <h1>Gerard Metal Shingles</h1>
    
<a href="/perl/review.pl?brand_id=231&amp;equip_type=shingle">Write a review of Gerard shingles</a>
<br><a href="/shingles/reviews/gerard/">Read Reviews of Gerard Shingles </a>
    <h3>Product Summary</h3>
    <p>
        Gerard Roofing Technologies is the manufacturer of stone-coated metal roofing products and 
        metal roof panels. Gerard uses 26-gauge primed, galvanized steel. The shingles are coated 
        with stone granules. Gerard forms the metal shingles into shapes that closely resemble 
        traditional roofing products, such as wooden shake and clay tiles. They also offer a line 
        of roofing products that are plain, durable, metal panels. These panels feature raised seams 
        to prevent water leaks. 
    </p>
    <p>
        Gerard makes the following shingle lines: 
        </p><ul>
            <li>Gerard shake shingles</li>
            <li>Gerard tile shingles</li>
            <li>Canyon shake shingles</li>
            <li>Guardian shingles</li>
            <li>Granite ridge roofs</li>
    ...
    <h3>History</h3>
    <p>
        In the United States, Gerard's shingles are marketed under Gerard Roofing Technologies; in 
        Europe and Asia, the shingles are marketed under the Allmet product name. Gerard Roofing 
        Technologies began manufacturing metal shingles in 1971. Gerard's corporate headquarters 
        are based in Brea, California.  
    </p>
    <h3>Gerard's Warranty</h3>
    <p>
        Gerard roofing products carry a transferable, lifetime limited warranty. The warranty is transferable 
        to one subsequent owner. The roof is warranted for 50 years from the date of installation. The 
        warranty covers winds up to 120 mph and hail damage from hail stones up to 2 1/2 inches in diameter. 
        As with all products, we recommend you inspect the warranty carefully to make sure you understand 
        its terms. 
    </p>
    <h3>Roof Repair</h3>
    <p>
    ...
    <p>
        Mail:<br>  
            ...
            Gerard Roofing Technologies<br>
