...
<a href="/perl/review.pl?brand_id=228&amp;equip_type=shingle">Write a review of Elk shingles</a>
<br><a href="/shingles/reviews/elk/">Read Reviews of Elk Shingles </a><br><img src="{{url('asset/shingles/brands/elk.jpg')}}" alt="Elk Shingles" border="0" style="margin-top:16px;">
    <p>
        Prior to its acquisition by <a href="/shingles/brands/gaf.html">GAF Materials Corp.</a>, Elk offered five patented brand names of asphalt shingles. 
        These included Prestique®, Raised Profile, Domain® Winslow®, and Capstone®. The"legacy" brands have since been discontinued by GAF Materials, 
        although some information about these products is still available from GAF. 
    </p>
   
    <p>
        Elk claimed its lamination made its product, at 1/2-inch, twice as thick as others on the market. The base was UltraMat® reinforced fiberglass, whih
        aided in preventing damage from fire, rot and warping. The WindGuard® sealant helped protect Elk shingles from wind blow-off. 
    </p>
    <h3>History</h3>
    <p>
        ElkCorp. began roofing shingle production in 1955. 
        In 2007, Elk was acquired by GAF Materials Corp. For some time after the acquisition the two lines remained separate, 
        but GAF has since discontinued most Elk brands. 
    </p>
    <p>
        GAF was founded in 1886 and, as of a 2010 Freedonia Group study, was North America's largest manufacturer of commercial and residential roofing. The company 
        regularly earns nearly $3 billion in annual sales.
    </p>
    <h3>Roof Repair</h3>
    <p>
    ...
    <h3>Contacting Elk</h3>
    <div class="mailing_addr">
        GAF Materials Corp.<br> 
        1361 Alps Road<br>
        Wayne, NJ 07470 <br><br>
        Phone: (973) 628-3000
    </div>
    <h3>Warranty</h3>
    <p>
        The base GAF warranty provides 10 years of coverage on material defects and up to 130 mph wind damage. The warranty is transferable. The company offers 
        additional warranty options covering up to 50 years, some of which include coverage for workmanship. 
    </p>
